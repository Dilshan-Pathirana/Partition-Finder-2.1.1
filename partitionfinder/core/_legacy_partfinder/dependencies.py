...
for dep in DEPENDENCIES:
    try:
        ...
        print('Could not find the dependency %s, please check that you have '
              ...
              ' and try again.' %(dep))
        print('\nPartitionFinder 2 requires a few'
              ' other Python packages to work. All of these '
              'can be installed easily using pip: '
              '\n\npip install numpy pandas tables pyparsing scipy scikit-learn')
        print('\nOr you can install the Anaconda Python distribution (Python 3.8+), '
